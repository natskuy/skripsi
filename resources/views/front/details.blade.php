            ...
            <div class="flex items-center justify-between gap-2">
                <div class="flex items-center gap-1">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="text-darkGrey text-xs leading-[20px] tracking-035">1 hari lalu</p>
                    </div>
                </div>
        ...
        <div class="flex gap-4">
            <div class="flex flex-col gap-3">
                <p class="font-semibold">2.547 <span
                        class="font-normal text-sm leading-[22px] tracking-035 text-darkGrey">Ulasan</span></p>
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="flex gap-1">
                    <div class="w-12 h-12 flex shrink-0 rounded-lg overflow-hidden relative">
                        <img src="{{asset('assets/thumbnails/kemeja-garis.jpeg')}}"
                            class="w-full h-full object-cover object-center" alt="thumbnail">
                    </div>
                    <div class="w-12 h-12 flex shrink-0 rounded-lg overflow-hidden relative">
