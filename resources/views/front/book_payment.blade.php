...
<section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
    ...
    <form enctype="multipart/form-data" action=" {{route('front.book_payment_store', $packageBooking->id)}}"
        class="flex flex-col gap-8" method="POST">
        @csrf
        @method('PATCH')
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="" class="w-full h-full object-contain object-center" alt="logo">
                        </div>
                        <span
                            class="text-sm tracking-035 leading-[22px]">{{$packageBooking->bank->bank_account_name}}</span>
                    </div>
                </div>
                <div class="flex flex-col gap-1">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span id="bank-number" class="text-sm tracking-035 leading-[22px]"
                            data-value="7342333056">{{$packageBooking->bank->bank_account_number}}</span>
                        <button type="button"
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="flex items-center justify-between">
                        <span id="total-payment" class="font-semibold text-lg tracking-[0.6px] leading-[26px]"
                            data-value="2500000">Rp
                            {{number_format($packageBooking->total_amount, 0, ',', '.')}}</span>
                        <button type="button"
                            class="font-semibold text-sm tracking-035 leading-[22px] text-blue w-fit ml-auto"
        ...
        <div class="flex flex-col gap-3 px-4 ">
            ...
            <div
                ...
                <div class="flex flex-col -ml-[38px] relative z-10">
                    ...
                    <p class="text-xs leading-[22px] tracking-035 text-white">Checkout today and get
                        reward!</p>
                </div>
        ...
        <div
            ...
            <div class="flex flex-col justify-center gap-1">
                ...
                <p id="grandtotal" class="text-[#EED202] font-semibold text-lg leading-[26px] tracking-[0.6px]">
                    Rp {{number_format($packageBooking->sub_total, 0, ',', '.')}}</p>
            </div>
