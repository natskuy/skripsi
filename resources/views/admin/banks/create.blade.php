            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.package_banks.store')}}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="bank_name" class="block mt-1 w-full" type="text" name="bank_name" required autofocus autocomplete="name" />
                        <x-input-error :messages="$errors->get('bank_name')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="bank_account_name" :value="__('bank_account_name')" />
                        <x-text-input id="bank_account_name" class="block mt-1 w-full" type="text" name="bank_account_name" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="bank_account_number" class="block mt-1 w-full" type="number" name="bank_account_number" required autofocus autocomplete="name" />
