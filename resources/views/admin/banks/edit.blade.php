...
@method('PUT')
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="bank_account_number" class="block mt-1 w-full" type="number" name="bank_account_number" value="{{$packageBank->bank_account_n}}" required autofocus autocomplete="name" />
