...
<body class="font-poppins text-black">
    <section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
        <nav class="mt-8 px-4 w-full flex items-center justify-between">
            ...
            <p class="text-center m-auto font-semibold">History Order</p>
            <div class="w-12"></div>
        </nav>
            ...
            <a href="{{route('dashboard.booking.details', $booking->id)}}" class="card">
                <div class="bg-white p-4 rounded-[26px] flex items-center gap-4">
                    <p class="text-center text-sm leading-[22px] tracking-035"><span
                            class="font-semibold text-2xl">{{$booking->start_date->format('d')}}</span>
                        <br>{{$booking->start_date->format('M')}}<br>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <p class="text-sm leading-[22px] tracking-035 text-darkGrey">{{$booking->quantity}} packs
                            </p>
                            @if($booking->is_paid)
                            <div
