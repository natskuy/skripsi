<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.package_banks.index')"
                        :active="request()->routeIs('admin.package_banks.index')">
                        {{ __('Banks') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('customer')
            <x-responsive-nav-link :href="route('dashboard.bookings')"
            ...
            <x-responsive-nav-link :href="route('admin.package_banks.index')"
                :active="request()->routeIs('admin.package_banks.index')">
                {{ __('Banks') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('admin.package_tours.index')"
                :active="request()->routeIs('admin.package_tours.index')">
                {{ __('Package Tours') }}
                </x-responsive-nav-linkk>

                <x-responsive-nav-link :href="route('admin.package_bookings.index')"
                    :active="request()->routeIs('admin.package_bookings.index')">
                    {{ __('Package Bookings') }}
                </x-responsive-nav-link>
        </div>
